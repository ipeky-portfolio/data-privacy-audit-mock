...
| Ordner | Inhalt |
| :--- | :--- |
| `00_PIMS_Governance` | Datenschutzrichtlinien, Rollen (DSB) |
| `01_Verarbeitungstaetigkeiten`| Verzeichnis der Verarbeitungstätigkeiten (VVT), Risikoanalyse |
| `02_Betroffenenrechte` | Prozesse für Auskunft, Löschung, Widerruf |
